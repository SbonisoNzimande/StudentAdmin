...
* Please **do not** use the issue tracker for personal support requests.  Stack
  Overflow ([`bootstrap-table`](https://stackoverflow.com/questions/tagged/bootstrap-table) tag is better place to get help.
...
3. **Isolate the problem** &mdash; ideally create a live example. 
    The web tool [jsfiddle](https://jsfiddle.net/) is a very helpful for this. Consider to use these templates:
    * [Table from html](https://jsfiddle.net/wenyi/e3nk137y/11/light/)
    * [Table from data](https://jsfiddle.net/wenyi/e3nk137y/13/light/)
    * [Table from url](https://jsfiddle.net/wenyi/e3nk137y/14/light/)
    * Other templates can also be found at [jsFiddle Bootstrap](https://bootstrap-table.wenzhixin.net.cn/examples/#basic)
