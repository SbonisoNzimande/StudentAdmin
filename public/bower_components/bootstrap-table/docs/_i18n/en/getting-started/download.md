...
The folks over at [CDNJS](https://www.cdnjs.com/libraries/bootstrap-table) and [bootcss](https://open.bootcss.com/bootstrap-table/) graciously provide CDN support for CSS and JavaScript of Bootstrap table. Just use these CDN links.
...
Install and manage Bootstrap table's CSS, JavaScript, locales, and extensions using [Bower](https://bower.io/).
